set(CURRENT_LIBRARY_NAME certificate-processing)
...
source_group("Certificate processing" FILES ${CURRENT_SRC_FILES})
...
target_link_libraries(${CURRENT_LIBRARY_NAME}              ${PROJECT_LIBRARIES_LIST})
